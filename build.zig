...
const dependencies = [4]RepoImport{
    .{
        .name = "rss-sub",
        .url = "https://github.com/bonbud-macryg/rss-sub",
        .commit = "ae4830a5d96f042375a38570fee37896723868eb",
        .prefix = "desk",
        .paths = &.{
            "lib/manx-utils.hoon",
            "lib/rss-sub.hoon",
            "mar/atom/entries.hoon",
            "mar/atom/entry.hoon",
            "mar/atom/feed.hoon",
            "mar/feed/items.hoon",
            "mar/feed/last-update.hoon",
            "mar/feed/maximum.hoon",
            "mar/feed/urls.hoon",
            "mar/rss-sub/update.hoon",
            "mar/rss/channel.hoon",
            "mar/rss/item.hoon",
            "mar/rss/items.hoon",
            "sur/rss-atom.hoon",
            "sur/rss-sub.hoon",
    ...
    .{
        .name = "mast-lib",
        .url = "https://github.com/urbit/mast",
        .commit = "7bd33b0f40814d478477c6f34a68c7ef9e9e9f7d",
        .prefix = "",
        .paths = &.{
            "lib/mast.js",
            "lib/mast.hoon",
            ...
            "mar/mast/bind.hoon",
            "mar/mast/poke.hoon",
            "mar/mast/unbind.hoon",
        },
    },
    .{
        .name = "landscape",
        .url = "https://github.com/tloncorp/landscape",
        .commit = "04a25a8481582c2827162bd8b874fc524f94f6db",
        .prefix = "desk-dev",
        .paths = &.{
            "lib/docket.hoon",
            "sur/docket.hoon",
